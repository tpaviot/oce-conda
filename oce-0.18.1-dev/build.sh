...
if [ `uname` != Darwin ]; then
    python $RECIPE_DIR/remove-system-libs.py $PREFIX/lib/oce-0.18-dev/OCE-libraries-release.cmake
else
    python $RECIPE_DIR/remove-system-libs.py $PREFIX/OCE.framework/Versions/0.18-dev/Resources/OCE-libraries-release.cmake
fi
